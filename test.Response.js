...
function setupSSE() {
    ...
    //     console.log("Received data with", data.data.length, "items");
    ...
    //                 </tr>
    //             </thead>
    //             <tbody id="meme-table-body"></tbody>
    //         </table>
    //     `;
    ...
    //     // Populate table
    //     const tableBody = document.getElementById("meme-table-body");
    //     data.data.forEach((meme) => {
    //         const row = document.createElement('tr');
    //         row.innerHTML = `

                
    //             <td> <div class="cell small-12 medium-6 large-4">
    //         <div class="card">
    //           <div class="card-divider">
    //             Meme Title 3
    //           </div>
    //           <img <img src="${meme.name}" 
    //                      class="meme-image"
    //                      onerror="this.onerror=null;this.src='placeholder.jpg'"
    //           <div class="card-section">
    //             <p> ${meme.id}Meme description or controls</p>
    //           </div>
    //         </div>
    //       </div></td>
    //         `;
    ...
    //     // Simple debug output
    //     console.log("Table should now show", data.data.length, "rows");
        
    // } catch (error) {
    //     console.error("Error:", error);
    //     document.getElementById("show").innerHTML = `
    //         <div class="error">Error loading memes: ${error.message}</div>
    //     `;
    // }
    ...
    showContainer.innerHTML = `
        <div class="meme-grid-container" id="meme-grid-container"></div>
    `;
    
    const gridContainer = document.getElementById("meme-grid-container");
    
    // Create grid items for each meme
    data.data.forEach((meme) => {
        const memeItem = document.createElement('div');
        memeItem.className = 'meme-grid-item';
        memeItem.innerHTML = `
             <div class="card">
                ...
                <span><i class="fi-dislike"></i>         <button class="cta-button"> <svg class="icons" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  <path d="M5 20h14v-2H5v2zM12 3v10l4-4h-3V3h-2v6H8l4 4V3z"/>
 ...
 12</span>
                ...
                `;
        gridContainer.appendChild(memeItem);
    });
