document.addEventListener('DOMContentLoaded', function() {
    fetch('start.php')
        ...
        .then(data => {
            ...
            const gridContainer = document.getElementById("show");
            gridContainer.innerHTML = '';
            
            data.data.forEach((meme) => {
                const memeItem = document.createElement('div');
                memeItem.className = 'cell small-12 medium-6 large-4'; // Foundation grid classes
                memeItem.innerHTML = `
                    <div class="card">
 ...
 12</span>
 <span>
 <i class="fi-comment"><div>
    <img class="profile" src="zedmems.jpg" alt="profile">
    <p>@username</p></div>
            ...
            // Proper Foundation reinitialization
            if (typeof Foundation !== 'undefined') {
                // Reinitialize all components
                $(document).foundation(); 
                
                // OR reinitialize specific components if needed
        ...
        .catch(error => {
            ...
            document.getElementById("show").innerHTML = `
                <div class="callout alert">
                    Error loading memes. Please refresh the page.
                </div>
            `;
        });
});